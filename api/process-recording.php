...
**summary 마지막 줄에 'AI 의견:' 한 줄 필수 — 해당 고객 대응 추천**:
  - 마지막 단락 (또는 단락 뒤 빈 줄 한 개 후) 에 "AI 의견: ..." 형식으로 추가
  - **이 고객에게 어떻게 대응하는 게 효과적인지 구체적 추천**:
  ...
  지난번 자료 평수 작다는 피드백 받음. 35평 이상 매물 요청.

  9억대 후보 두세 건 정리해 내일 오전 카톡 발송 약속함.

  AI 의견: 가족(시아버지) 의사결정 의존이 큰 유형. 다음 통화 전 시아버지 우려할 만한 평형/관리비/안전 자료 준비 + 동반 답방 권유. 가격 압박은 피하고 환경/조건 강조가 효과적.
