...
import { initSupabase, apiRequest, getSession, refreshNavForms } from './auth-shared.js?v=20260516-login-header-sync';
import {
...
} from './ledger-shared.js?v=20260516-login-header-sync';
