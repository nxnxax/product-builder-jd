...
import { initSupabase, apiRequest, getSession } from './auth-shared.js?v=20260517-token-refresh';
...
async function getAccessTokenForSms() {
    const { getAccessToken } = await import('./auth-shared.js?v=20260517-token-refresh');
