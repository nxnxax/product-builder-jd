...
/* ========== Plan check ==========
 * 구독 plan 별 quota (사장님 2026-06-18 — 출시기념 할인가, VAT 포함 최종):
 *   agency  → 월 1,500분 (결제 ₩39,900 VAT포함, 정가 89,000)
 *   master  → 월   700분 (결제 ₩28,900 VAT포함, 정가 47,000)
 *   sales   → 월   300분 (결제 ₩14,900 VAT포함, 정가 24,000)
