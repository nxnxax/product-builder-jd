...
import { initSupabase, apiRequest, getSession } from './auth-shared.js?v=20260512-form-settings';
import { attachColumnFilters, applyColumnFilters, openRowAddModal, attachPhoneAutoFormat, getEffectiveFields, mountFieldManager,
         ...
         isLedgerMobile, onLedgerViewportChange } from './ledger-shared.js?v=20260512-form-settings';
