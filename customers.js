...
import { initSupabase, apiRequest, getSession } from './auth-shared.js?v=20260516-nickname-header';
...
async function getAccessTokenForSms() {
    const { getAccessToken } = await import('./auth-shared.js?v=20260516-nickname-header');
