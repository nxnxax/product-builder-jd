...
[항목] — 아래 5개를 제목 그대로 한 줄에 적고, 각 3~5문장. 위 방식으로 종합해 풀어라. 각 항목엔 좋은 점과 '조심할 약점'을 함께 담아라. 항목 사이는 빈 줄로 구분. 순서도 그대로 지켜라(오늘의 운세는 반드시 맨 마지막).
...
[언어] 반드시 한글로만 써라. 중국어 한자(钱财·盛夏 등), 일본식 한자, 영어 단어(like, energy 등)를 한 글자도 섞지 마라. 전부 한글로 옮겨 써라(盛夏→한여름, like→처럼). 간지(병오·갑오 등)도 한글로 적고, 한자를 꼭 보여야 하면 괄호로만(예: 병오(丙午)).
