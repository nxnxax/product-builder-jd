...
**형식: 화자별 줄바꿈 + 화자 명시 접두사. 마지막에 'AI 의견:' 한 줄.**

각 발화 / 행동을 한 줄씩 적되, 줄 앞에 화자를 명시:
  나: ...
  고객: ...

예시:
  나: 매물을 찾았다고 고객님에게 먼저 연락함
  고객: 평수가 맘에 든다고 함
  나: 9억대 후보 두세 건 정리해서 내일 오전 발송 약속
  고객: 시아버지와 상의 후 답변하겠다고 함
  나: 자료 보내고 3일 후 재컨택 예정

  AI 의견: 고객 의사결정에 시아버지 영향 큼. 3일 follow-up 시 시아버지 의향도 함께 확인 권장.

화자 식별 규칙:
- "나" = 영업측 / 통화 건 본인 (영맨 사용자)
- "고객" = 상대방
- 화자 라벨([화자1]/[화자2]) 이 있으면 그것으로 판단. 없으면 발화 흐름과 호칭으로 추론.
- 일반적으로 영업 콜은 영업측이 먼저 인사하고 매물/자료 제안하는 쪽, 고객은 반응하고 질문하는 쪽.

말투:
  - "~했음", "~임", "~함" 보고서식 명사형/축약형 종결
  - 또는 명사구 끝맺음 ("재컨택 권장", "자료 발송 약속")
  - "~습니다/~입니다/~네요/~요" 정중 종결 금지

각 줄에 포함해야 할 정보 (해당하는 줄에만):
  ① 통화 개시 맥락 (누가 먼저 무슨 주제 꺼냈는지)
  ② 다뤄진 주제 (가격, 일정, 매물, 자료, 조건, 위치, 면적 등)
  ③ 고객 반응 (관심, 망설임, 거절, 동의, 감정)
  ④ 영업측 약속/제안
  ⑤ 구체적 숫자 (가격, 평수, 시기, 인원, 비율)
  ⑥ 합의된 다음 단계, 보류, 미정
  ⑦ 통화 종료 맥락

**AI 의견 한 줄 필수** — summary 마지막 줄.
  - 형식: "AI 의견: ..." 정확히
  - 내용: 영업 follow-up 관점에서 전략적 한 줄 (예: "고객 관심도 높음, 빠른 답방 권장")
  - 1~2문장 이내. 추측 금지 (transcript 단서 기반).

**분량 제한 없음.** 통화가 길면 줄 수 늘림 (10분 통화 = 10~20줄, 30분 = 30+줄).
짧은 통화도 화자 줄바꿈 형식 유지 (각자 1~2줄).
요약은 "압축" 이 아니라 "재서술" — 누락 절대 금지.
