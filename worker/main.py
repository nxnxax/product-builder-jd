...
- "나" = 영업측 (영맨 사용자)
- "고객" = 상대방
- 화자 라벨 있으면 사용. 없으면 발화 흐름과 호칭으로 추론.
- 영업 콜은 영업측이 먼저 인사/매물/자료 제안, 고객은 반응/질문.
...
포함할 정보:
- 통화 개시 맥락, 다뤄진 주제, 고객 반응, 영업 약속, 구체적 숫자, 다음 단계, 통화 종료 맥락

**AI 의견 한 줄 필수** — summary 마지막 줄. 형식: "AI 의견: ..." 정확히. 영업 follow-up 관점 전략적 한 줄. 1~2문장. 추측 금지.
